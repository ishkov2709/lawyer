      ...
      <Container>
        ...
        <div className={css.aboutWrapper}>
          ...
          <ul className={css.featureList}>
            ...
            <li className={css.featureItem}>
              <p className={css.featureText}>
                постійно стежу за змінами у законодавстві та не допускаю
                правової неактуальності у своїй роботі.
              </p>
            </li>
            <li className={css.featureItem}>
              <p className={css.featureText}>
            ...
            <li className={css.featureItem}>
              <p className={css.featureText}>
                принесена користь для клієнта має бути незмірно більшою, ніж
                його використані ресурси.
              </p>
            </li>
          </ul>
        </div>
